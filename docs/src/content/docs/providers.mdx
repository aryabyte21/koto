...
:::note
Local models are slower and generally lower quality than cloud APIs, but they're free, private, and work offline. They work well for development and testing, with a cloud provider for production.
:::
...
:::caution
When switching providers, consider running `npx koto translate --force` once to re-translate everything. Different models produce slightly different translations, and a full re-run ensures consistency.
:::
